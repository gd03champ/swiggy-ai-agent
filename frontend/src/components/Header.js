...
const Header = () => {
  ...
  return (
    <>
      ...
      <div
        className={`header flex items-center justify-between z-20 px-12 fixed w-screen top-0 left-0 right-0 shadow-[0_15px_40px_-20px_rgba(40,44,63,0.15)] bg-[#edf7f9] ${
        ...
        <div className="max-w-[25%] flex items-center gap-2">
          <Link to="/">
            <img
              ...
              className="w-36 h-auto pl-4 p-3"
              src={logo}
